 ...
 * 새 프로세스의 스레드 ID를 반환하거나 스레드를 만들 수 없는 경우 
 * TID_ERROR를 반환합니다. */
tid_t
...
duplicate_pte (uint64_t *pte, void *va, void *aux) {
	 ...
	 *    TODO: NEWPAGE. */
	/* 3. TODO: 자식에 대한 새 PAL_USER 페이지를 할당하고 
				결과를 NEWPAGE로 설정합니다. */
	...
	/* 4. TODO: 부모 페이지를 새 페이지로 복제하고 
				부모 페이지가 쓰기 가능한지 확인합니다
				(결과에 따라 WRITABLE 설정). */
	 ...
	 *    permission. */
	/* 5. WRITABLE 권한이 있는 주소 VA의 자식 페이지 테이블에 
		새 페이지를 추가합니다. */
